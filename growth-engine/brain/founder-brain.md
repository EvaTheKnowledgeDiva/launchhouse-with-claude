...
- **Model:** service
- **Hybrid:** true
- **Stage:** Pre-revenue, MVP in build
- **Locked:** 2026-09-16
...
**Core capabilities named by the founder:**
- One-tap and voice-note data capture, usable by paras as well as the teacher
- Real-time charts of goal progress
- Alerts for regression and for mastery, so new goals can be written at the right moment
- Incident documentation by voice, including CPI restraint holds
- Service minute documentation
- Spreadsheet export, so no double data entry into the school's own system

**Pricing:** $10/month or $95/year, paid by the individual teacher. Intent is to move to district-paid contracts later, once there is enough usage history with teachers. Not the 90-day motion.

**Problem in customer language:** "I meet with Sam's parents next week for an IEP meeting, but I have no idea how to show what areas he has grown in and the other areas he's still struggling with. What do I show the parents?"

**Why Captured rather than the alternative:**
- The real incumbent is a paper tracker or a TPT printable plus a DIY Google Form and spreadsheet. Those get lost, are hard to read, and cost evenings of manual entry.
- Main software competitor is **AbleSpace**, which has no voice-to-text documentation and is reportedly hard for teachers to set up the first time. It is also the name teachers already give each other in the comments of SpEd Facebook groups, so Captured is entering a room where the incumbent has word-of-mouth and Captured has none.
...
- ~40 of those 42 are certified special education teachers.
- 0 paying customers.

**Customer discovery**
- Interviewed Assistant Principal Davol "DJ" Johnson, who is both an administrator and the parent of a student with an IEP.
- Johnson stated that for CPI occurrences where staff must restrain a student, voice note capture "would be essential to the documentation that they need to protect their staff from litigation."
- Johnson's special education department ended the school year **300,000 service minutes behind**. Parents are entitled to compensation for services promised and not rendered, a cost she described as "shutting it down."
- Johnson confirmed that a spreadsheet export would avoid creating double data entry, dependent on the school's documentation platform. Her school uses **Frontline**.
- Teachers recommend AbleSpace unprompted in the comments of the founder's own SpEd Facebook advisor group, checked by me on 2026-09-21.

**Gaps, stated plainly**
- The MVP has not been shown to anyone. It is not ready. All product proof is currently promise, not evidence.
- No user testimonials, no usage data, no case studies.
- Number of IEPs written or progress reports filed by the founder: **unknown**.
- Number of teacher interviews beyond the Johnson interview: **unknown**.

## Goal, next 90 days
1. Get the MVP ready.
2. Pull in revenue inside the 90 days, as a placeholder or prepay for the app to be delivered.
3. 300 teachers signed up to purchase.
4. 1,000 on the waitlist.
...
- Waitlist now: **42** (≈40 certified SpEd teachers)
- Price: **$10/month, or $95/year**
- Average monthly value per customer: **$10/month** ($7.92/month equivalent on the annual plan)
- Target purchasers in 90 days: **300**
- Target waitlist in 90 days: **1,000**
- Implied MRR at 300 monthly-plan customers: **$3,000/month**
- Current monthly revenue: **$0**
- Waitlist-to-paid conversion rate: **unknown**, no history to project from
...
- The SpEd Instagram accounts her teachers follow. Founder does not know these yet and has said she will research them.

Both are where the persona's attention already sits, so the gap is load-bearing for content.

### Founder's own learning, not audience material
Recorded separately so nothing downstream mistakes these for what teachers read. These are YouTube channels Eva was pointed at to learn how data trackers work:
- https://www.youtube.com/watch?v=41EJyIwZ3j4&t=1s
